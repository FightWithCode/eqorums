...
class OpenPositionView(APIView):
	def post(self, request):
		...
		for i in request.FILES:
			...
			all_doc_link.append(uploaded_file_url)
		if request.data.get('hiring_group'):
			hiring_group_id  = request.data.get('hiring_group')
		elif request.data.get('drafted'):
			hiring_group_id = 0
			hiring_group_objs = HiringGroup.objects.filter(hod_profile=request.user.profile)
			if hiring_group_objs:
				hiring_group_id = hiring_group_objs.last().group_id
		else:
			return Response({'error': 'select hring group'}, status=status.HTTP_400_BAD_REQUEST)
		...
		position_obj = OpenPosition.objects.create(
			...
			decumentation=json.dumps(all_doc_link),
			special_intruction=request.data.get('special_intruction'),
			hiring_group=hiring_group_id,
			...
			init_qualify_ques_1=request.data.get('init_qualify_ques_1'),
			init_qualify_ques_2=request.data.get('init_qualify_ques_2'),
			init_qualify_ques_3=request.data.get('init_qualify_ques_3'),
			init_qualify_ques_4=request.data.get('init_qualify_ques_4'),
			init_qualify_ques_5=request.data.get('init_qualify_ques_5'),
			init_qualify_ques_6=request.data.get('init_qualify_ques_6'),
			init_qualify_ques_7=request.data.get('init_qualify_ques_7'),
			init_qualify_ques_8=request.data.get('init_qualify_ques_8'),

			init_qualify_ques_suggestion_1=request.data.get('init_qualify_ques_suggestion_1'),
			init_qualify_ques_suggestion_2=request.data.get('init_qualify_ques_suggestion_2'),
			init_qualify_ques_suggestion_3=request.data.get('init_qualify_ques_suggestion_3'),
			init_qualify_ques_suggestion_4=request.data.get('init_qualify_ques_suggestion_4'),
			init_qualify_ques_suggestion_5=request.data.get('init_qualify_ques_suggestion_5'),
			init_qualify_ques_suggestion_6=request.data.get('init_qualify_ques_suggestion_6'),
			init_qualify_ques_suggestion_7=request.data.get('init_qualify_ques_suggestion_7'),
			init_qualify_ques_suggestion_8=request.data.get('init_qualify_ques_suggestion_8'),

			init_qualify_ques_weightage_1=request.data.get('init_qualify_ques_weightage_1'),
			init_qualify_ques_weightage_2=request.data.get('init_qualify_ques_weightage_2'),
			init_qualify_ques_weightage_3=request.data.get('init_qualify_ques_weightage_3'),
			init_qualify_ques_weightage_4=request.data.get('init_qualify_ques_weightage_4'),
			init_qualify_ques_weightage_5=request.data.get('init_qualify_ques_weightage_5'),
			init_qualify_ques_weightage_6=request.data.get('init_qualify_ques_weightage_6'),
			init_qualify_ques_weightage_7=request.data.get('init_qualify_ques_weightage_7'),
			init_qualify_ques_weightage_8=request.data.get('init_qualify_ques_weightage_8'),

			no_of_open_positions=request.data.get('no_of_open_positions'),
			sec_ques_1=request.data.get('sec_ques_1'),
			sec_ques_2=request.data.get('sec_ques_2'),
			sec_ques_3=request.data.get('sec_ques_3'),
			sec_ques_4=request.data.get('sec_ques_4'),
			sec_ques_5=request.data.get('sec_ques_5'),
			sec_ques_6=request.data.get('sec_ques_6'),
			sec_ques_7=request.data.get('sec_ques_7'),
			sec_ques_8=request.data.get('sec_ques_8'),
			...
			drafted=request.data.get('drafted'),
			work_auth=request.data.get("work_auth"),
			work_location=request.data.get("work_location"),
		)
		client_obj.open_positions = client_obj.open_positions + 1
		client_obj.save()
		response = {}
		# add deadlines
		if not position_obj.drafted or position_obj.drafted == "False":
			...
			try:
				...
				tasks.send_app_notification.delay(client_obj.key_username, 'A new position has been created - ' + position_obj.position_title)
				tasks.push_notification.delay([client_obj.key_username], 'Qorums Notification', 'A new position has been created - ' + position_obj.position_title)
				# send notifications to HTMs
				hiring_group = HiringGroup.objects.get(group_id=hiring_group_id)
				for profile_obj in hiring_group.members_list:
			...
			# send emails
			group_obj = HiringGroup.objects.get(group_id=hiring_group_id)
			for htm_profile in group_obj.members_list.all():
				if htm_profile == group_obj.hod_profile:
					continue
				try:
					subject = 'New Open Position - Qorums'
					names = []
					for i in Profile.objects.filter(is_sm=True, client=str(position_obj.client)):
						names.append(i.user.get_full_name())
					if group_obj.hod_profile:
						manager_name = group_obj.hod_profile.user.get_full_name()
					else:
						manager_name = "None"
					d = {
						"user_name": htm_profile.user.get_full_name(),
						"hiring_team_name": group_obj.name,
					...
					# htmly_b = get_template('position_created.html')
					# text_content = ""
	...
	def put(self, request):
		response = {}
		try:
			# Checking if new docs were uploaded, if yes then change it or pass
			...
			if loop:
				position_obj.decumentation = json.dumps(all_doc_link)
			else:
				pass
			position_obj.special_intruction = request.data.get('special_intruction')
			if position_obj.hiring_group == request.data.get('hiring_group'):
				pass
			else:
			...
			position_obj.init_qualify_ques_1 = request.data.get('init_qualify_ques_1')
			position_obj.init_qualify_ques_2 = request.data.get('init_qualify_ques_2')
			position_obj.init_qualify_ques_3 = request.data.get('init_qualify_ques_3')
			position_obj.init_qualify_ques_4 = request.data.get('init_qualify_ques_4')
			position_obj.init_qualify_ques_5 = request.data.get('init_qualify_ques_5')
			position_obj.init_qualify_ques_6 = request.data.get('init_qualify_ques_6')
			position_obj.init_qualify_ques_7 = request.data.get('init_qualify_ques_7')
			position_obj.init_qualify_ques_8 = request.data.get('init_qualify_ques_8')
			
			position_obj.init_qualify_ques_weightage_1 = request.data.get('init_qualify_ques_weightage_1')
			position_obj.init_qualify_ques_weightage_2 = request.data.get('init_qualify_ques_weightage_2')
			position_obj.init_qualify_ques_weightage_3 = request.data.get('init_qualify_ques_weightage_3')
			position_obj.init_qualify_ques_weightage_4 = request.data.get('init_qualify_ques_weightage_4')
			position_obj.init_qualify_ques_weightage_5 = request.data.get('init_qualify_ques_weightage_5')
			position_obj.init_qualify_ques_weightage_6 = request.data.get('init_qualify_ques_weightage_6')
			position_obj.init_qualify_ques_weightage_7 = request.data.get('init_qualify_ques_weightage_7')
			position_obj.init_qualify_ques_weightage_8 = request.data.get('init_qualify_ques_weightage_8')
			
			position_obj.init_qualify_ques_suggestion_1 = request.data.get('init_qualify_ques_suggestion_1')
			position_obj.init_qualify_ques_suggestion_2 = request.data.get('init_qualify_ques_suggestion_2')
			position_obj.init_qualify_ques_suggestion_3 = request.data.get('init_qualify_ques_suggestion_3')
			position_obj.init_qualify_ques_suggestion_4 = request.data.get('init_qualify_ques_suggestion_4')
			position_obj.init_qualify_ques_suggestion_5 = request.data.get('init_qualify_ques_suggestion_5')
			position_obj.init_qualify_ques_suggestion_6 = request.data.get('init_qualify_ques_suggestion_6')
			position_obj.init_qualify_ques_suggestion_7 = request.data.get('init_qualify_ques_suggestion_7')
			position_obj.init_qualify_ques_suggestion_8 = request.data.get('init_qualify_ques_suggestion_8')
			
			position_obj.sec_ques_1 = request.data.get('sec_ques_1')
			position_obj.sec_ques_2 = request.data.get('sec_ques_2')
			position_obj.sec_ques_3 = request.data.get('sec_ques_3')
			position_obj.sec_ques_4 = request.data.get('sec_ques_4')
			position_obj.sec_ques_5 = request.data.get('sec_ques_5')
			position_obj.sec_ques_6 = request.data.get('sec_ques_6')
			position_obj.sec_ques_7 = request.data.get('sec_ques_7')
			position_obj.sec_ques_8 = request.data.get('sec_ques_8')
	...
	def get(self, request):
		try:
			...
			for i in data:
				i['decumentation'] = json.loads(i['decumentation'])
				i['stages'] = json.loads(i['stages'])
			response = {}
			response['data'] = data
			return Response(response, status=status.HTTP_200_OK)
		except Exception as e:
	...
	def delete(self, request):
		try:
			op_id = int(request.query_params.get('op_id'))
			if int(op_id) == int(settings.EXAMPLE_POSITION) and not request.user.is_superuser:
				response = {}
				response['msg'] = 'This position can not be deleted!'
				return Response(response, status=status.HTTP_400_BAD_REQUEST)
			for i in OpenPosition.objects.filter(id=op_id):
				client_obj = Client.objects.get(id=i.client)
				i.delete()
				client_obj.open_positions = OpenPosition.objects.filter(disabled=False, client=client_obj.id).count()
				client_obj.save()
			response = {}
			response['msg'] = 'deleted'
			return Response(response, status=status.HTTP_200_OK)
...
# To update status of an Open Position - Not used anymore
class UpdateOpenPositionStageCompletionView(APIView):
	def post(self, request, op_id):
		try:
			stage_complete_obj = OpenPositionStageCompletion.objects.filter(op_id=op_id)
			if stage_complete_obj:
				stage_serializer = OpenPositionStageCompletionSerializer(stage_complete_obj[0], data=request.data)
				if stage_serializer.is_valid():
					stage_serializer.save()
				else:
					response = {}
					response['error'] = str(stage_serializer.errors)
					return Response(response, status=status.HTTP_400_BAD_REQUEST)
			else:
				print("else")
				stage_serializer = OpenPositionStageCompletionSerializer(data=request.data)
				if stage_serializer.is_valid():
					stage_serializer.save()
				else:
					response = {}
	...
	def get(self, request, op_id):
		try:
			stage_complete_obj = OpenPositionStageCompletion.objects.filter(op_id=op_id)
			if stage_complete_obj:
				stage_serializer = OpenPositionStageCompletionSerializer(stage_complete_obj[0])
				response = {}
				response['data'] = stage_serializer.data
				return Response(response, status=status.HTTP_200_OK)
			else:
				response = {}
	...
	def get(self, request):
		...
		try:
			...
			for client in active_clients:
				...
				try:
					clients.append(client.logo.url)
				except:
...
class BasicClientDetailView(APIView):
	...
	def get(self, request):
		try:
			...
			if client_obj.logo:
				response["logo"] = client_obj.logo.url
			else:
				response["logo"] = None
			client_obj.save()
			response['msg'] = 'fetched'
	...
	def put(self, request):
		try:
			...
			# try:
			# 	client_obj.logo = request.data.get('logo').replace('api/media/', '')
			# except:
